...
const tickerItems = [
  "Безплатна доставка за поръчки над €250",
  "30 дни за връщане",
  "Над 20 години опит в индустрията",
  "Над 20 000 доволни клиенти",
  "Естествена кожа и прецизна изработка",
]
...
export default function StoreShell({ children }: { children: ReactNode }) {
  ...
  return <>
    ...
    <header className="site-header">
      ...
      <a className="logo" href="/">MOJO <em>LEATHER</em></a>
    ...
    {children}
    <footer><div className="footer-grid"><div><a className="logo light" href="/">MOJO <em>LEATHER</em></a><p>Кожа с характер. Проектирано в София.</p></div><div><h3>Магазин</h3><a href="/women">Жени</a><a href="/men">Мъже</a><a href="/#shop">Нови модели</a></div><div><h3>Помощ</h3><a href="/blog">Доставка и връщане</a><a href="/blog">Размери</a><a href="/blog">Грижа за кожата</a></div><div><h3>Последвай ни</h3><a href="#">Instagram</a><a href="#">Pinterest</a><a href="#">TikTok</a></div></div><div className="copyright">© 2026 Mojo Leather <span>BG / EUR</span></div></footer>
    <div className={`drawer-overlay ${menuOpen || cartOpen ? "open" : ""}`} onClick={() => { setMenuOpen(false); setCartOpen(false) }}/>
    <aside className={`drawer menu-drawer ${menuOpen ? "open" : ""}`} aria-hidden={!menuOpen}><button className="drawer-close" onClick={() => setMenuOpen(false)} aria-label="Затвори">×</button><nav><a href="/women">Жени</a><a href="/men">Мъже</a><a href="/#story">За нас</a><a href="/blog">Блог</a></nav><p>София, България<br/>hello@mojoleather.com</p></aside>
